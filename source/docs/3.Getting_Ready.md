...
(1) Open the CanMV IDE tool and select **"Tools-K210 Burning Tool"**. (The **"CanMV IDE"** tool can be found in the same directory as this document, and its installation method can be referred to in [3.1.1 Serial driver installation](#anchor_3_1_1)).
...
<img src="../_static/media/chapter_3/section_6/image7.png" class="common_img" />
