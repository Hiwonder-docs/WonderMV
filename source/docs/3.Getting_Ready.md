...
(2) If the driver is not available, you can find the [Serial Driver Installation Package]() in the same directory as this section.
...
(1) Double-click to open the [canmv-ide-windows-v2.9.2.exe]() file located in the same directory as this document.
...
When running a program, the device connection area in the bottom left corner changes to the above status. Press <img src="../_static/media/chapter_3/section_3/media/image5.png"  /> to stop online execution.
...
<img src="../_static/media/chapter_3/section_4/media/image2.jpeg" class="common_img" />

(2) Double-click <img src="../_static/media/chapter_3/section_4/media/image3.png" /> to launch the CanMV IDE software.
...
<img src="../_static/media/chapter_3/section_4/media/image9.png" class="common_img" />

<img src="../_static/media/chapter_3/section_4/media/image10.jpeg" class="common_img" />
...
<img src="../_static/media/chapter_3/section_4/media/image14.png" class="common_img" />

(4) Once completed, disconnect from CanMV IDE, and the program will run automatically. The running effect will be the same as described in the previous section [3.4.2 Routine Test -> Online Program Execution]().
...
<img class="common_img" src="../_static/media/chapter_3/section_5/media/image3.png"  /><img class="common_img" src="../_static/media/chapter_3/section_5/media/image4.png"  />
...
Then, after connecting the vision module, click <img src="../_static/media/chapter_3/section_5/media/image7.png"  />, and if you see the printed information in the **"Serial Terminal"** as shown in the picture below, it means the import was successful.

<img class="common_img" src="../_static/media/chapter_3/section_5/media/image8.png"  />
...
Here are two methods for firmware burning and erasure. You can choose either method for learning.

### 3.6.1 Burn through CanMV IDE

:::{Note}
This step will clear the Flash space of the K210, and after clearing, you need to reprogram the firmware to connect to the CanMV IDE software.
:::

* **Erase the Original Firmware**

(1) Open the CanMV IDE tool and select **"Tools-K210 Burning Tool"**. (The **"CanMV IDE"** tool can be found in the same directory as this document, and its installation method can be referred to in [3.1.1 Serial driver installation](#3.1.1-serial-driver-installation)).

<img src="../_static/media/chapter_3/section_6/media/image2.png" class="common_img" />

(2) Select **"Switch to Erase"**.

<img src="../_static/media/chapter_3/section_6/media/image3.png" class="common_img" />

(3) Choose **"Full Chip Erase"**, select the correct serial port (using COM72 as an example), and then click **"Erase"**.

<img src="../_static/media/chapter_3/section_6/media/image4.png" class="common_img" />

(4) Wait for the prompt **"Flash Erase Successful"**, indicating that the original firmware has been erased.

<img src="../_static/media/chapter_3/section_6/media/image5.png" class="common_img" />

* **Burn the Factory Firmware**

(1) After erasing the original firmware, switch to burning by clicking **"Switch to Burn"**.

<img src="../_static/media/chapter_3/section_6/media/image6.png" class="common_img" />

(2) Click **"Browse"**, select the firmware in the same directory as this document, choose the correct serial port, and click **"Download"**.

<img src="../_static/media/chapter_3/section_6/media/image7.png" class="common_img" />

(3) Wait for the successful completion of the burning process.

<img src="../_static/media/chapter_3/section_6/media/image8.png" class="common_img" />

### 3.6.2 Burn Through Kflash GUI

(1) In the [kflash_gui_v1.6.5_2_windows.7z]() burning tool compression package in this section's directory, extract it and find the [Kflash_gui.exe]() software, then open it.

<img src="../_static/media/chapter_3/section_6/media/image9.png" class="common_img" />

<img src="../_static/media/chapter_3/section_6/media/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_6/media/image11.png" class="common_img" />

(3) Wait for the successful completion of the downloading process.

<img src="../_static/media/chapter_3/section_6/media/image12.png" class="common_img" />

### 3.6.3 Burning Effect

When the K210 is powered on, you should see the vision module displaying the current captured image.

<img src="../_static/media/chapter_3/section_6/media/image13.png" class="common_img" />

(1) Press the **K1** button to toggle the on/off state of the fill light.

<img src="../_static/media/chapter_3/section_6/media/image14.png" class="common_img" />

(2) Press the **K2** button to toggle the on/off state of the blue LED light.

<img src="../_static/media/chapter_3/section_6/media/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_6/media/image16.png" class="common_img" />
...
You can find the installation package [serial_port_utility_latest.exe]() in the same directory as this document. You can follow the installation instructions:
...
<img src="../_static/media/chapter_3/section_8/media/image3.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image4.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image5.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image6.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image7.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image8.png" class="common_img" />

<img src="../_static/media/chapter_3/section_8/media/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_8/media/image10.png" class="common_img" />
...
(2) We'll use the program provided in [1. Tutorial Material->2. K210 Module Development Tutorial->2. Basic Hardware Course->2.9 UART Serial Communication Experiment](#) on the K210 side as an example. The program will send the following string.

<img src="../_static/media/chapter_3/section_8/media/image11.png" class="common_img" />

For instructions on how to run or download the program, please refer to [3. CanMV IDE Basic Usage](#).
...
<img src="../_static/media/chapter_3/section_8/media/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_8/media/image13.png" class="common_img" /><img src="../_static/media/chapter_3/section_8/media/image14.png" class="common_img" />

(4) After clicking <img src="../_static/media/chapter_3/section_8/media/image15.png"   />, you should be able to see the string message sent by the K210 module.

<img src="../_static/media/chapter_3/section_8/media/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_8/media/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_8/media/image18.png" class="common_img" />
...
Click on <img src="../_static/media/chapter_3/section_9/media/image3.png" />, then view the printed information in the serial terminal.

<img src="../_static/media/chapter_3/section_9/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_9/media/image5.png" class="common_img" />

<img src="../_static/media/chapter_3/section_9/media/image6.png" class="common_img" />

<img src="../_static/media/chapter_3/section_9/media/image7.png" class="common_img" />

<img src="../_static/media/chapter_3/section_9/media/image8.png" class="common_img" />

(2) After opening the TF card formatting tool, select the drive letter of the TF card, and then click on **"Format"**.

<img src="../_static/media/chapter_3/section_9/media/image9.png" class="common_img" />

<img src="../_static/media/chapter_3/section_9/media/image10.png" class="common_img" />