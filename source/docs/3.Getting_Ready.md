...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">FPIOA() . set_function(pin, func)</th>
  </tr>
  <tr>
    <td >Function Description</td>
    <td >Set the peripheral function corresponding to the pin(pin mapping)</td>
  </tr>
  <tr>
    <td >Parameter List</td>
    <td >
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">FPIOA() . get_Pin_num(func)</th>
  </tr>
  <tr>
    <td >Function Description</td>
    <td >Get which pin a peripheral is mapped to.</td>
  </tr>
  <tr>
    <td >Parameter List</td>
    <td >
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">GPIO(ID, MODE, PULL, VALUE)</th>
  </tr>
  <tr>
    <td >Function Description</td>
    <td >Return a GPIO control object.</td>
  </tr>
  <tr>
    <td >Parameter List</td>
    <td >
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">GPIO.value([value])</th>
  </tr>
  <tr>
    <td >Function Description</td>
    <td >Modify or read the GPIO pin state.</td>
  </tr>
  <tr>
    <td >Parameter List</td>
    <td >
  ...
  <tr>
    <td >Return Value</td>
    <td >If the [value] parameter is empty, it returns the current state of the GPIO pin.</td>
  </tr>
  <tr>
    <td >Example</td>
    <td >/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  <tr>
    <th colspan="2">GPIO.irq(CALLBACK_FUNC, TRIGGER_CONDITION, GPIO.WAKEUP_NOT_SUPPORT, PRORITY)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Configure an interrupt handler to be called when the trigger source of the pin is in an active state. If the pin mode is pin.in, the trigger source is the external value on the pin.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">GPIO.mode(MODE)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Set GPIO input/output mode.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">KPU.load(offset, file_path)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Load a model from flash or the file system.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
  ...
  <tr>
    <td>Return Value</td>
    <td>If loaded correctly, it returns the KPU network object (kpu network). Otherwise, it raises an error.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">KPU.load_flash(model_addr, is_dual_buf, batch_size, spi_speed)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Load a model from flash or the file system.</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  <tr>
    <th colspan="2">KPU.init_yolo2(kpu_net, threshold, nms_value, anchor_num, anchor)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>This function initializes parameters for the YOLOv2 network model. It is only used when employing YOLOv2.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
  ...
  <tr>
    <td>Return Value</td>
    <td>success：bool type, indicating whether the operation was successful.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">KPU.deinit(kpu_net)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Release the memory occupied by the model while keeping the variable intact. You can use del kpu_net_object to delete it.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td><strong>kpu_net:</strong> KPU network object</td>
  </tr>
  <tr>
    <td>Return Value</td>
    <td><strong>success：</strong>bool type, indicating whether the operation was successful.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">KPU.run_with_output(img_obj)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Run object detection model using KPU.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>img_obj：Image object.</td>
  </tr>
  <tr>
    <td>Return Value</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">KPU.regionlayer_yolo2()</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Obtain detection results.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
  ...
  <tr>
    <td>Return Value</td>
    <td>Returns a two-dimensional list, each sublist represents a recognized target object, and the target object information list package.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.reset([, freq=24000000[, set_regs=True[, dual_buff=False]]])</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Reset and initialize a monocular camera.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.set_framesize(framesize[, set_regs=True])</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Used to set the frame size of the camera output. The development board's screen is configured with a resolution of 320x240 pixels. It is recommended to set it to QVGA format.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.run(enable)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Image capture functionality control</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td><strong>enable:</strong> 1 to start capturing images; 0 to stop capturing images.</td>
  </tr>
  <tr>
    <td>Return Value</td>
    <td><strong>success：</strong>bool type，indicating whether the operation was successful.</td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.snapshot()</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Take a photo using the camera.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>/</td>
  ...
  <tr>
    <td>Return Value</td>
    <td><strong>img:</strong> The returned image object</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="max-width:700px;width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.shutdown(enable)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Close camera.</td>
  ...
  <tr>
    <td>Parameter List</td>
    <td><strong>enable:</strong> True means turning on the camera False means turning off the camera</td>
  </tr>
  <tr>
    <td>Return Value</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">sensor.skip_frames(n, [, time])</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Skip a specified number of frames or skip images within a specified time interval to allow the camera image to stabilize after changing camera settings.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.init(type=1, freq=15000000, color=lcd.BLACK, invert = 0, lcd_type = 0)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Initialize the LCD screen display.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.display(image, roi=Auto, oft=(x, y))</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Display an image (GRAYSCALE or RGB565) on the LCD screen.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.clear(color)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Clear the LCD screen to black or a specified color.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.rotation(dir)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Set the orientation of the LCD screen.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
  ...
  <tr>
    <td>Return Value</td>
    <td>The current direction, with values ranging from 0 to 3.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.mirror(invert)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Set whether the LCD screen is displayed in mirror mode.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
  ...
  <tr>
    <td>Return Value</td>
    <td>The current setting for mirror display. Returns True or False.</td>
  </tr>
  <tr>
    <td>Example</td>
    <td>/</td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">lcd.fill_rectangle(x, y, w, h, color)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Fill the specified area of the LCD.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">touchscreen . init(i2c=None, cal=None)</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Initialize the touchscreen.</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>
...
<table class="docutils-nobg" border="1" style="width:100%">
  ...
  <col width="66%">
  <tr>
    <th colspan="2">touchscreen . read()</th>
  </tr>
  <tr>
    <td>Function Description</td>
    <td>Read the current screen status and the coordinate value of the pressed point</td>
  </tr>
  <tr>
    <td>Parameter List</td>
    <td>/</td>
